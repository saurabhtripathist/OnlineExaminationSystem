<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="editquestion.aspx.cs" Inherits="Online_Examination_System.WebForm14" %>
     ...
     <div class="col-md-12">
        <div class="card">
            ...
            <div class="btn-group mt-1">
                <asp:Button ID="btn_paneleditquestion" runat="server" Text="Edit Question" CssClass="btn btn-info rounded-1" BorderStyle="None" CausesValidation="False" />
            </div>
            <div class="card-body">
                ...
                <div class="card-footer">
                        <div class="offset-2">
                            <asp:Button ID="btn_editquestion" runat="server" Text="Edit Question" CssClass="btn btn-success" BorderStyle="None" ForeColor="White" OnClick="btn_editquestion_Click"/>
                        </div>
