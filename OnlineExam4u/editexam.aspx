<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="editexam.aspx.cs" Inherits="Online_Examination_System.WebForm13" %>
...
<div class=" container">
            ...
            <div class="btn-group mt-1">
                <asp:Button ID="btn_paneleditexam" runat="server" Text="Edit Exam" CssClass="btn btn-info" BorderStyle="None" CausesValidation="False" />
            </div>
            ...
            <div class="card-body">
                ...
                <div class="card-footer">
                    <div class="offset-2">
                        <asp:Button ID="btn_editexam" runat="server" Text="Edit Exam" CssClass="btn btn-primary"  BorderStyle="None" ForeColor="White" OnClick="btn_editexam_Click"/>
                    </div>
