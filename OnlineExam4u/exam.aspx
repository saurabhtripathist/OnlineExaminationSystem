<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="exam.aspx.cs" Inherits="Online_Examination_System.WebForm16" %>
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="btn-group bg-danger">
                ...
                <asp:Button ID="btn_paneladdexam" runat="server" Text="Add Exam" CssClass="btn btn-primary" BorderStyle="None" CausesValidation="False" OnClick="btn_paneladdexam_Click" />
            </div>
            ...
            <asp:Panel ID="panel_addexam" runat="server">
                <div class="card-body">
                    ...
                    <div class="card-footer">
                        <div class="offset-2">
                            <asp:Button ID="btn_addexam" runat="server" Text="Add Exam" CssClass="btn btn-success rounded-2"  BorderStyle="None" ForeColor="White" OnClick="btn_addexam_Click" />
                        </div>
                            ...
                            <asp:GridView ID="grdview_examlist" runat="server" GridLines="None" CssClass="table table-bordered" AutoGenerateColumns="False" OnRowCommand="grdview_examlist_RowCommand" AllowPaging="True" OnPageIndexChanging="grdview_examlist_PageIndexChanging" PageSize="5">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Options">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="btn_detailsexam" runat="server" CssClass="btn btn-info" BorderStyle="None" ForeColor="White" NavigateUrl='<%# "examdetails.aspx?eid=" + Eval("exam_id") %>'>
                                            <i class="bi bi-info-circle" aria-hidden="true"></i> Details
                                            </asp:HyperLink>
                                            <asp:HyperLink ID="btn_editexam" runat="server" CssClass="btn btn-primary" BorderStyle="None" ForeColor="White" NavigateUrl='<%# "editexam.aspx?eid=" + Eval("exam_id") %>'>
                                            <i class="bi bi-pencil-square" aria-hidden="true"></i> Edit
                                            </asp:HyperLink>
                                            <asp:LinkButton ID="btn_deleteexam" runat="server" CssClass="btn btn-danger" BorderStyle="None" ForeColor="White" CommandArgument='<%# Eval("exam_id") %>' CommandName="deleteexam">
                                            <i class="bi bi-trash" aria-hidden="true"></i> Delete
                                            </asp:LinkButton>
                                            <asp:HyperLink ID="btn_addquestion" runat="server" CssClass="btn btn-secondary" BorderStyle="None" ForeColor="White" NavigateUrl='<%# "addquestion.aspx?eid=" + Eval("exam_id") %>'>
                                            <i class="bi bi-plus-circle" aria-hidden="true"></i> Add Question
                                            </asp:HyperLink>
                                            <asp:HyperLink ID="btn_viewquestion" runat="server" CssClass="btn btn-success" BorderStyle="None" ForeColor="White" NavigateUrl='<%# "examquestion.aspx?eid=" + Eval("exam_id") %>'>
