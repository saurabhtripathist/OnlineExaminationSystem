<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="detailsexamquestion.aspx.cs" Inherits="Online_Examination_System.WebForm11" %>
   ...
   <div class="col-md-12">
        <div class="card">
            ...
            <div class="btn-group mt-1">
                <asp:Button ID="btn_detailsexamquestion" runat="server" Text="Details Exam Question" CssClass="btn btn-info rounded-1 text-white" BorderStyle="None" CausesValidation="False" />
            </div>
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="table table-responsive">
                        <asp:DetailsView ID="gridview_examdetails" runat="server" GridLines="None" CssClass="table table-bordered" AutoGenerateRows="False">
                            ...
                            <FooterTemplate>
                                <asp:Button ID="btn_backquestion" runat="server" Text="Back" CssClass="btn btn-success rounded-3" BorderStyle="None" ForeColor="White" PostBackUrl="~/examquestion.aspx" />
                            </FooterTemplate>
