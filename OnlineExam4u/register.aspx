<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="Online_Examination_System.register" %>
...
<body class="bg-dark">
    <div class="container">
        <div class="card card-register mx-auto mt-5">
            <div class="card-header bg-primary text-white m-2 p-3">Registeration</div>
            <div class=" container">
            ...
            <div class="card-body">
                <form runat="server" id="formregister">
                    ...
                    <div class="text-center">
                        ...
                        <a class="d-block small" href="forgotpassword.aspx"> Forgotten Password?</a>
                    </div>
                </form>
